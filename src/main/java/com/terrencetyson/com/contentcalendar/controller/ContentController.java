package com.terrencetyson.com.contentcalendar.controller;
...
public class ContentController {
    ...
    public Optional<Content> findById(@PathVariable Integer id) {
        return Optional.of(repository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Content not found!")));
    }
